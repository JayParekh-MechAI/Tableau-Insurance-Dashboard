# Tableau-Insurance-Dashboard
A Tableau dashboard made from a health insurance dataset to analyse leading factors in insurance prices

Medical Insurance Cost Analysis: Interactive Tableau Dashboard

Project Overview

This project involves the development of a comprehensive business intelligence dashboard using Tableau to visualize the key drivers of medical insurance charges. By analyzing a dataset of 1,338 records, I identified how lifestyle factors (smoking), demographics (region), and physical metrics (BMI) correlate with healthcare costs.

Key Analytical Insights

Demographic & Lifestyle Correlations

Utilizing a multi-layered bar chart, I compared regional average charges against smoker status.

Primary Finding: Lifestyle choice (smoking) is a higher cost-driver than geography.
